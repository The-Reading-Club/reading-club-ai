    ...
    >
      ...
      <footer className="py-12 px-6 bg-[#FFC122] text-[#FFF]">
        ...
        >
          ...
          <Link href="/it" className="opacity-80 text-white">
            {/* {dictionary.page.landing.copyRight} */}
            {"Italiano"}
          </Link>
          <Link href="/de" className="opacity-80 text-white">
            {/* {dictionary.page.landing.copyRight} */}
            {"Deutsch"}
          </Link>
          ...
          <Link href="/zh-TW" className="opacity-80 text-white">
            {/* {dictionary.page.landing.copyRight} */}
            {"繁體中文"}
          </Link>
          ...
          <Link href="/ko" className="opacity-80 text-white">
            {/* {dictionary.page.landing.copyRight} */}
            {"한국인"}
          </Link>
          ...
          <Link href="/vi" className="opacity-80 text-white">
            {/* {dictionary.page.landing.copyRight} */}
            {"Tiếng Việt"}
          </Link>
          ...
          <Link href="/tr" className="opacity-80 text-white">
            {/* {dictionary.page.landing.copyRight} */}
            {"Türkçe"}
          </Link>
          <Link href="/pl" className="opacity-80 text-white">
            {/* {dictionary.page.landing.copyRight} */}
            {"Polski"}
          </Link>
          <Link href="/ro" className="opacity-80 text-white">
            {/* {dictionary.page.landing.copyRight} */}
            {"Română"}
          </Link>
        </div>
