...
// LANGUAGES
//https://github.com/diegomura/react-pdf/issues/2251
// DEMO
// https://github.com/diegomura/react-pdf/issues/2251#issuecomment-1473419382
// https://react-pdf-repl.vercel.app/?cp_code=JYWwDg9gTgLgBAbzgFQKYA8YBo4AUCGA5qjgCIQDGAriKgHbZwBiEDOAasKgO5wC-cAGZQIIOACIAAlFT4KMALRgAJoID0MustQyo4gNwAoQywYA6GYWABnGDoAUCQ3CH4QwADYBPAFwSAShAARhAwEOJYznDWUBR-4gAWMDBg1j5qahTKdABW1mYUHhBUqh74MgWiavg5-OhqHsBB1mrAdADWagDMZgCMfQAMaoKsMC2BIWEawaEQCrTKwDQK3KhBI-bJghGGfACURiajFqhWtg5OLoJunr4SAPJg9HAAyvh01jsuMXESSSlpDIbMZmQi2fAwYAUSogNQtCBPD7vFoAN16AHY1LQQAAOACa-AA4tZegAmABsAFlgAAtMAAIQAggoAKpMdg0gaoMxbHb7Q4YSCwODaa5UDzwex7OAAXgAfHB7FEADzkai0BhyqIuZUEYjalzRYAAL1QMoQAG0ugMBgBdPgG74wLweM0IJD4RqEOgASTsIDSEgo9DsehwOSotmAgi8AGFRiH4sGGDoInAwPhlIs6IQ_L0BvwHYa4FrizrODxS2WdWhMNFna7zUhgS8Tag8wMcBQIEUoPEAMT4IfiQty4DwbjQdppZVqWswKvV5Xz-sut3N0ZMG7eeITWYjvh8RfVuCAWhBAEIggD4QODnwCsIIAuEEAgiDnuCAXhBAAwgcEAAiCAYRBH4_70vQAeEAQEdxCLE8awweBbDXJshE3bc7nER5njeD4DyPAAJVAPCKOAAHVoA8ZRZ3nY9izI6CtUdQ1l2g1dG3dBCGFbU0Oy7HtoAHId8Ewsd4GUCBUGsOgAHIJynHwqMwCi6JXWCmI3Bgt3cHcHkRV5kX42jiwva87yfF8P2_P8AOAuAcLwiBCOI5RdLgGSF1o2cK24Y9Zz1VAq1nNUaBDLUDkMIA&modules=true

// https://github.com/notofonts/noto-cjk/tree/main/Serif#downloading-noto-serif-cjk
// https://chat.openai.com/c/2761749a-1f97-4f50-8f13-82fd44d16c03
...
Font.register({
  family: "Ukraine Roboto",
  src: "https://cdnjs.cloudflare.com/ajax/libs/ink/3.1.10/fonts/Roboto/roboto-medium-webfont.ttf",
});

Font.register({
  family: "Simplified Chinese",
  // src: "https://raw.githubusercontent.com/notofonts/noto-cjk/main/Serif/Variable/TTF/NotoSerifCJKsc-VF.ttf",
  src: "https://storage.googleapis.com/reading-club-covers/fonts/NotoSerifCJKsc-VF.ttf",
});
Font.register({
  family: "Thai Noto Regular",
  src: "https://storage.googleapis.com/reading-club-covers/fonts/NotoSansThai-Regular.ttf",
});
// Font.register({
//   family: "Noto Sans Regular",
//   src: "https://storage.googleapis.com/reading-club-covers/fonts/NotoSans-Regular.ttf",
// });
Font.register({
...
function overrideFontStyle(sampleText: string) {
  ...
  // ukraine characters
  else if (langCode === "ukr" || langCode === "bul") {
    Object.assign(overrideStyle, {
    ...
    <Document>
      <Page style={styles.body}>
        ...
        {/* <Text style={styles.header}>
          {JSON.stringify(tiptapEditorContent, null, 2)}
        </Text> */}
      </Page>
    </Document>
  );
...
const fetchImageAsBase64 = (imageUrl: string) => {
  return new Promise<string>((resolve, reject) => {
    // Here you would use fetch or axios to get the image and then convert it to Base64
    fetch(imageUrl)
      .then((response) => {
