...
const suggestions1 = [
  {
    ...
    content: [
      {
        type: "text",
        text: "Once upon a time, deep in a ",
        marks: [
          {
      ...
      {
        type: "text",
        text: ", there lived a large family of bats. I don't know how many bats. It was somewhere between 50 and 100 bats. It was a very big bat family.",
      },
    ],
  },
  {
...
const suggestions3 = [
...

  {
    ...
    content: [
      ...
      {
        type: "text",
        text: "a young bat named Echo became curious about the faint light that filtered in from a distant corner of their vast home. Echo's curiosity sparked a sense of adventure among the younger bats.",
      },
    ],
  },
  {
    ...
    content: [
      {
        type: "text",
        text: "Together, they embarked on a journey towards the light, uncovering hidden paths and forgotten chambers within the cave. ",
        marks: [
          {
            type: "customSuggestion",
            attrs: {
  ...
  // ... [continue with the story, wrapping new additions as suggestions]
];

export const contentWithSuggestions = {
  type: "doc",
  content: [...suggestions1, ...suggestions2, ...suggestions3],
};

export const contentWithSuggestions2 = {
  type: "doc",
...
export const caveStoryTestTipTapJSONV2: JSONContent = {
  type: "doc",
  content: [
    {
      type: "paragraph",
